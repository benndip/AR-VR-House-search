...
const Palor = ({ sceneNavigator }) => {
    ...
    return (
        <ViroScene>
            ...
            <Viro360Image source={require('../../../res/images/house2/h1.jpg')} />
            ...
            >
                ...
                />
                <ViroText position={[-0.2, -0.4, -1]} text="Enter Room" style={{ color: '#f1f2f6', fontWeight: 'bold' }} />
            </ViroNode>
            <ViroNode
                position={[0.5, 0.3, -1]}
            >
                ...
                />
                <ViroText position={[0.5, -0.4, -1]} text="Enter Toilet" style={{ color: '#f1f2f6', fontWeight: 'bold' }} />
            </ViroNode>
        </ViroScene>
    )
}
